...
// ------------ worse still vec5 stuff here ----------------

// set a vec 4 to a value
void v4FloatToVecM(vec5 u,const float a, const float b, const float c, const float d);

// adds u into v
void v4AddToVecM(vec5 v, const vec5 u);

// clips values in u to a maximum of v
void v4ClipMaxM(vec5 u, const vec5 v);

// copy vector
void v4CopyM(vec5 v, const vec5 u);
