...
void materialClass::setMaterialYellowPlastic()
{
	setAmbient(0.0, 0.0, 0.0, 1);
	setDiffuse(0.5, 0.5, 0.0, 1);
	setSpecular(0.60, 0.60, 0.50, 1);
	setEmissive(0, 0, 0, 0);
	setShinyInt((int)128*0.25);
}

void materialClass::setMaterialGreenPlastic()
{
	setAmbient(0.0, 0.0, 0.0, 1);
	setDiffuse(0.1, 0.35, 0.1, 1);
	setSpecular(0.45, 0.55, 0.45, 1);
	setEmissive(0, 0, 0, 0);
	setShinyInt((int)128*0.25 );
}
...
void materialClass::setMaterialSilver()
{
	setAmbient(0.19225, 0.19225, 0.19225, 1);
	setDiffuse(0.50754, 0.50754, 0.50754, 1);
	setSpecular(0.508273, 0.508273, 0.508273, 1);
	setEmissive(0, 0, 0, 0);
	setShinyInt((int)128*0.4);
}
